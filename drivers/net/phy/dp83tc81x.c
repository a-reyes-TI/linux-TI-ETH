...
#define DP83TC81x_NO_FRAME_INT_EN		BIT(3)
#define DP83TC81x_POR_DONE_INT_EN		BIT(4)
...
static const struct dp83tc81x_init_reg DP83TC81x_master_cs2_0_init[] = {
	{0x1F, 0x001F, 0x8000},
	{0x1F, 0x0523, 0x0001},
...
static const struct dp83tc81x_init_reg DP83TC81x_slave_cs2_0_init[] = {
	{0x1F, 0x001F, 0x8000},
	{0x1F, 0x0523, 0x0001},
...
static int dp83tc81x_chip_init(struct phy_device *phydev)
{
	...
	case DP83TC812_CT:
		if (DP83TC81x->is_master) {
			ret = dp83tc81x_write_seq(phydev, DP83TC81x_master_cs2_0_init,
						  ARRAY_SIZE(DP83TC81x_master_cs2_0_init));
			phy_set_bits_mmd(phydev, MMD1F, 0x018B, BIT(6));
			//Enables Autonomous Mode
			} else {
				ret = dp83tc81x_write_seq(phydev, DP83TC81x_slave_cs2_0_init,
							  ARRAY_SIZE(DP83TC81x_slave_cs2_0_init));
				phy_set_bits_mmd(phydev, MMD1F, 0x018B, BIT(6));
				//Enables Autonomous Mode
			}
			break;
...
static int dp83tc81x_config_intr(struct phy_device *phydev)
{
	...
	if (phydev->interrupts == PHY_INTERRUPT_ENABLED) {
		...
		misr_status |= (DP83TC81x_LPS_INT_EN |
				...
				DP83TC81x_NO_FRAME_INT_EN |
				DP83TC81x_POR_DONE_INT_EN);
